import { supabase, Project, Task } from './supabase';
...
const demoTasks: Task[] = [
  ...
  { id: 't4', project_id: '2', title: 'Nghiệm thu PCCC', phase: 'Inspection', zone: 'All', owner: 'QA', priority: 'High', kanban_status: 'Review', planned_start: '2026-06-20', planned_end: '2026-06-28', actual_start: '2026-06-21', actual_end: null, progress_pct: 80, due_date: '2026-06-28', constraint_note: 'Chờ lịch cơ quan PCCC', notes: null },
];
